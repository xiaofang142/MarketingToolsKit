  ...
  <div class="auto-reply">
    ...
    <el-dialog v-model="loginDialogVisible" title="绑定账号与登录" width="600px">
      <div>
        ...
        <el-alert title="请按照以下步骤操作：1. 在新标签页打开快手网站；2. 登录你的账号；3. 按F12打开开发者工具，切换到Network或Application标签页；4. 复制登录后的Cookie；5. 粘贴到下方输入框；6. 选择是否使用无头浏览器；7. 点击保存Cookie。" type="info" show-icon />
        <el-divider />
        <p>粘贴登录后的 Cookie：</p>
